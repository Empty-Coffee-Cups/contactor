...
import { Veiw, TextInput, Button, Text, TouchableHighlight } from 'react-native'
import { Icon } from 'react-native-elements'
//import style

import { withNavigation, NavigationActions } from 'react-native'
    ...
    render() {
        ...
        return (
            <View style={style.container}>
                {
                    this.props.action_type == 'ADD_CONTACT' 
                ...
                <View style={styles.contact_byttons}>
                    <Button
                        ...
                        onPress={() => {this._pressed_submit(), navigate('Contact_detail', { name: this.state.name }) }}
                    />
                </View>
